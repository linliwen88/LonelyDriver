...
{
	Model::Draw(shader, modelMat, DrawWireframe, wheelDirection);
}

//
//void Vehicle::LoadModel(const std::string& path)
//{
...
//}
//
//void Vehicle::ProcessNode(aiNode* node, const aiScene* scene, Node* parentNode)
//{
...
//}
//
//Mesh Vehicle::ProcessMesh(aiMesh* mesh, const aiScene* scene)
//{
...
//}
//
//std::vector<Texture> Vehicle::LoadMaterialTextures(aiMaterial* mat, aiTextureType type, std::string typeName)
//{
//	std::vector<Texture> textures;
